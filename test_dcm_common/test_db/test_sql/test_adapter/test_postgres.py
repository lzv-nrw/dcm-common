...
from dcm_common.db import psycopg, PostgreSQLAdapter14
...
def test_postgres_caching_table_names(db: PostgreSQLAdapter14):
    """Test caching behavior of `PostgreSQLAdapter14.get_table_names`."""
...
@pytest.mark.skipif(not requirements_met, reason=skip_reason)
def test_postgres_caching_column_type(db: PostgreSQLAdapter14):
    """Test caching behavior of `PostgreSQLAdapter14.get_column_type`."""
...
@pytest.mark.skipif(not requirements_met, reason=skip_reason)
def test_postgres_caching_column_names(db: PostgreSQLAdapter14):
    """Test caching behavior of `PostgreSQLAdapter14.get_column_names`."""
...
@pytest.mark.skipif(not requirements_met, reason=skip_reason)
def test_postgres_caching_primary_key(db: PostgreSQLAdapter14):
    """Test caching behavior of `PostgreSQLAdapter14.get_primary_key`."""
...
@pytest.mark.skipif(not requirements_met, reason=skip_reason)
def test_postgres_caching_recovery(db: PostgreSQLAdapter14):
    """
    Test caching behavior of `PostgreSQLAdapter14` in case of changes
    to the db-schema.
    """
