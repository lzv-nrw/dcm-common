...
# FIXME fix naming conflict for PostgreSQLAdapter14 in key_value_store and sqlimport subprocess
...
def check_psycopg_dependencies():
    ...
    try:
        subprocess.run([sys.executable, "-c", "import psycopg"], check=True)
